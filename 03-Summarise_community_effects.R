...
for(g in 1:length(guilds)) {
  ...
  out[g, "TREND_hi"] <- QSLpersonal::BCI(TREND_hi, flag.sig = F, BCIpercent = 90)
  ...
  out[g, "TREND_lo"] <- QSLpersonal::BCI(TREND_lo, flag.sig = F, BCIpercent = 90)
  ...
  out[g, "TREND_bg"] <- QSLpersonal::BCI(TREND_bg, flag.sig = F, BCIpercent = 90)
  ...
  out[g, "DIFFTot_lo"] <- QSLpersonal::BCI(TREND_hi - TREND_lo, BCIpercent = 90)
  out[g, "DIFFTot_bg"] <- QSLpersonal::BCI(TREND_hi - TREND_bg, BCIpercent = 90)
