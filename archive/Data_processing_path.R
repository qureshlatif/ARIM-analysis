...
PSI.vars.trt <- c("Dev_bg", "Dev_lo", "WellD_3km", "WellA_1km", "Road_1km")

beta.vars.cntrl <- c("TPI_min", "Sage", "Herb")
beta.vars.trt <- c("Dev_bg", "Dev_lo", "WellA_125m", "Road_125m", "AHerb")

psi_dyn.vars.cntrl <- c("Sage", "Herb")
psi_dyn.vars.trt <- c("Dev_bg", "Dev_lo", "WellA_125m", "Road_125m", "AHerb")
